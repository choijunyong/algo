...
<script>
<%
boolean idCheck =(boolean)(request.getAttribute("userID"));
boolean pwCheck =(boolean)(request.getAttribute("password"));
boolean nicknameCheck =(boolean)(request.getAttribute("nickname"));
boolean phoneRestCheck =(boolean)(request.getAttribute("phoneRest"));
boolean getAlarm = (boolean)(request.getAttribute("getAlarm"));
%>
if(<%=getAlarm%>){
	$("#alarmCheck").html("알림방법을 선택해주세요");	
}
if(<%=phoneRestCheck%>){
	$("#phoneCheck").html("핸드폰 번호를 입력해주세요");	
}
if(<%=nicknameCheck%>){
	$("#nicknameCheck").html("닉네임을 입력해주세요");	
}
if(<%=pwCheck%>){
	$("#pwLengthCheck").html("비밀번호를 입력해주세요");	
}
if(<%=idCheck%>){
